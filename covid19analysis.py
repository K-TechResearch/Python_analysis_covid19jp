...
#githubからcsv取得
summary = pd.read_csv('https://github.com/kaz-ogiwara/covid19/raw/master/data/summary.csv')
#prefectures = pd.read_csv('https://github.com/kaz-ogiwara/covid19/raw/master/data/prefectures.csv')
#prefectures2 = pd.read_csv('https://github.com/kaz-ogiwara/covid19/raw/master/data/prefectures-2.csv')
#demography = pd.read_csv('https://github.com/kaz-ogiwara/covid19/raw/master/data/demography.csv')
